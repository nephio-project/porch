...
import (
	...
	"github.com/nephio-project/porch/api/generated/clientset/versioned/scheme"
...
type PorchV1alpha1Interface interface {
	...
	FunctionsGetter
	PorchPkgsGetter
	PorchPkgRevisionsGetter
	PorchPkgRevisionResourcesGetter
}
...
func (c *PorchV1alpha1Client) PorchPkgs(namespace string) PorchPkgInterface {
	return newPorchPkgs(c, namespace)
}

func (c *PorchV1alpha1Client) PorchPkgRevisions(namespace string) PorchPkgRevisionInterface {
	return newPorchPkgRevisions(c, namespace)
}

func (c *PorchV1alpha1Client) PorchPkgRevisionResources(namespace string) PorchPkgRevisionResourcesInterface {
	return newPorchPkgRevisionResources(c, namespace)
}

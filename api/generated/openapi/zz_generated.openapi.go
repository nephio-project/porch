...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/nephio-project/porch/api/porchresources/v1alpha1.PackageRevisionResources": schema_porch_api_porchresources_v1alpha1_PackageRevisionResources(ref),
...
func schema_porch_api_porchresources_v1alpha1_PackageRevisionResources(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PackageRevisionResources represents the contents of a package revision. This resource is in resources.porch.kpt.dev API group (separate from PackageRevision) due to Kubernetes routing constraints and remains as aggregated API due to size (1-100MB). Use controller-runtime client to access this resource.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/nephio-project/porch/api/porchresources/v1alpha1.PackageRevisionResourcesSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/nephio-project/porch/api/porchresources/v1alpha1.PackageRevisionResourcesStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/nephio-project/porch/api/porchresources/v1alpha1.PackageRevisionResourcesSpec", "github.com/nephio-project/porch/api/porchresources/v1alpha1.PackageRevisionResourcesStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

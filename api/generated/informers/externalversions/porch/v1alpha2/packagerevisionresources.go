...
type PackageRevisionResourcesInformer interface {
	...
	Lister() porchv1alpha2.PackageRevisionResourcesLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PorchV1alpha2().PackageRevisionResources(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PorchV1alpha2().PackageRevisionResources(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PorchV1alpha2().PackageRevisionResources(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PorchV1alpha2().PackageRevisionResources(namespace).Watch(ctx, options)
			},
		},
		&apiporchv1alpha2.PackageRevisionResources{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *packageRevisionResourcesInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiporchv1alpha2.PackageRevisionResources{}, f.defaultInformer)
}

func (f *packageRevisionResourcesInformer) Lister() porchv1alpha2.PackageRevisionResourcesLister {
	return porchv1alpha2.NewPackageRevisionResourcesLister(f.Informer().GetIndexer())
}

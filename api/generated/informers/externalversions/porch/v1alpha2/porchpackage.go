...
type PorchPackageInformer interface {
	...
	Lister() porchv1alpha2.PorchPackageLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PorchV1alpha2().PorchPackages(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PorchV1alpha2().PorchPackages(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PorchV1alpha2().PorchPackages(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PorchV1alpha2().PorchPackages(namespace).Watch(ctx, options)
			},
		},
		&apiporchv1alpha2.PorchPackage{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *porchPackageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiporchv1alpha2.PorchPackage{}, f.defaultInformer)
}

func (f *porchPackageInformer) Lister() porchv1alpha2.PorchPackageLister {
	return porchv1alpha2.NewPorchPackageLister(f.Informer().GetIndexer())
}

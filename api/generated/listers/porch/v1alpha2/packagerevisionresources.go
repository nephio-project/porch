...
type PackageRevisionResourcesLister interface {
	...
	List(selector labels.Selector) (ret []*porchv1alpha2.PackageRevisionResources, err error)
...
type packageRevisionResourcesLister struct {
	listers.ResourceIndexer[*porchv1alpha2.PackageRevisionResources]
}
...
func NewPackageRevisionResourcesLister(indexer cache.Indexer) PackageRevisionResourcesLister {
	return &packageRevisionResourcesLister{listers.New[*porchv1alpha2.PackageRevisionResources](indexer, porchv1alpha2.Resource("packagerevisionresources"))}
}

// PackageRevisionResources returns an object that can list and get PackageRevisionResources.
func (s *packageRevisionResourcesLister) PackageRevisionResources(namespace string) PackageRevisionResourcesNamespaceLister {
	return packageRevisionResourcesNamespaceLister{listers.NewNamespaced[*porchv1alpha2.PackageRevisionResources](s.ResourceIndexer, namespace)}
}
...
type PackageRevisionResourcesNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*porchv1alpha2.PackageRevisionResources, error)

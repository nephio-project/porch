...
//go:generate go run sigs.k8s.io/controller-tools/cmd/controller-gen@v0.19.0 object:headerFile="../../../scripts/boilerplate.go.txt" crd:crdVersions=v1,headerFile="../../../scripts/boilerplate.yaml.txt" output:crd:artifacts:config=. paths=./...

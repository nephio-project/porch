...
func (in *DBRepository) DeepCopyInto(out *DBRepository) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DBRepository.
func (in *DBRepository) DeepCopy() *DBRepository {
	if in == nil {
		return nil
	}
	out := new(DBRepository)
	in.DeepCopyInto(out)
	return out
}

...
const PRMetricsName = "PackageRevision"
...
func (r *packageRevisions) List(ctx context.Context, options *metainternalversion.ListOptions) (runtime.Object, error) {
	...
	defer func() {
		span.End()
		metrics.RecordAPICallDuration(PRMetricsName, "LIST", time.Since(start).Seconds())
	}()

	metrics.RecordRequestCount(ctx, PRMetricsName, "LIST")
...
func (r *packageRevisions) Get(ctx context.Context, name string, _ *metav1.GetOptions) (runtime.Object, error) {
	...
	defer func() {
		span.End()
		metrics.RecordAPICallDuration(PRMetricsName, "GET", time.Since(start).Seconds())
	}()

	metrics.RecordRequestCount(ctx, PRMetricsName, "GET")
...
func (r *packageRevisions) Create(ctx context.Context, runtimeObject runtime.Object, _ rest.ValidateObjectFunc,
	...
	defer func() {
		span.End()
		metrics.RecordAPICallDuration(PRMetricsName, "CREATE", time.Since(start).Seconds())
	}()

	metrics.RecordRequestCount(ctx, PRMetricsName, "CREATE")
...
func (r *packageRevisions) Update(ctx context.Context, name string, objInfo rest.UpdatedObjectInfo, createValidation rest.ValidateObjectFunc,
	...
	defer func() {
		span.End()
		metrics.RecordAPICallDuration(PRMetricsName, "UPDATE", time.Since(start).Seconds())
	}()

	metrics.RecordRequestCount(ctx, PRMetricsName, "UPDATE")
...
func (r *packageRevisions) Delete(ctx context.Context, name string, deleteValidation rest.ValidateObjectFunc, _ *metav1.DeleteOptions) (runtime.Object, bool, error) {
	...
	defer func() {
		span.End()
		metrics.RecordAPICallDuration(PRMetricsName, "DELETE", time.Since(start).Seconds())
	}()

	metrics.RecordRequestCount(ctx, PRMetricsName, "DELETE")

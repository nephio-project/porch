...
const wasmPath = process.env.` + WasmPathEnv + `
if (!wasmPath) {
    throw 'environment variable KPT_FN_WASM_PATH is expected to be set by the kpt wasm runtime'
}
...
// The JS glue code below mostly comes from
// https://github.com/golang/go/blob/master/misc/wasm/wasm_exec.js with minor
// changes. "misc/wasm/wasm_exec.js" is shipped with all golang installation.

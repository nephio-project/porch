...
//
//	"Unable to find image 'ghcr.io/kptdev/krm-functions-catalog/starlark:v0.3' locally"
...
//
//	"Trying to pull ghcr.io/kptdev/krm-functions-catalog/starlark:v0.3...atalog/starlark:v0.3..."

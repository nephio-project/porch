...
import (
	...
	"github.com/nephio-project/porch/controllers/rootsyncdeployments/api/v1alpha1"
	rssapi "github.com/nephio-project/porch/controllers/rootsyncsets/api/v1alpha1"
...
//go:generate go run sigs.k8s.io/controller-tools/cmd/controller-gen@v0.8.0 rbac:roleName=porch-controllers-rootsyncdeployments webhook paths="." output:rbac:artifacts:config=../../../config/rbac

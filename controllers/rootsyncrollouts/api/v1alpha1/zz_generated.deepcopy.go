...
func (in *RootSyncRolloutList) DeepCopyInto(out *RootSyncRolloutList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]RootSyncRollout, len(*in))
		for i := range *in {
...
func (in *RootSyncRolloutStatus) DeepCopyInto(out *RootSyncRolloutStatus) {
	*out = *in
	...
	if in.PackageStatuses != nil {
		in, out := &in.PackageStatuses, &out.PackageStatuses

...
func (in *CacheSync) DeepCopyInto(out *CacheSync) {
	*out = *in
	if in.RunOnceAt != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CacheSync.
func (in *CacheSync) DeepCopy() *CacheSync {
	if in == nil {
		return nil
	}
	out := new(CacheSync)
